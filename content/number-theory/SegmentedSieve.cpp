 ...
 * Date: 2025-11-20
 * License: CC0
 * Source: Segmented Sieve (SPOJ PRINT problem)
 * Description: Generates all primes in (l, r) using a segmented sieve.
 *     Usage:
 *         auto primes1 = sieve(100);   primes up to 100
 *         auto primes2 = segmentedsieve(1000, 2000);  
 * primes in (1000 to 2000)
 * Time: sieve O(limit log log limit), segmentedsieve  O((r-l) log r + sqrt(r))
 * Memory: O(r-l+sqrt(r))
 */
